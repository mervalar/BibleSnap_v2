...
export const createStyles = () => {
  ...
  return StyleSheet.create({
    ...
    header: {
      backgroundColor: 'transparent', paddingHorizontal: horizontalPadding, paddingTop: isTablet ? d.spacing.lg : d.spacing.md, paddingBottom: isTablet ? d.spacing.lg : d.spacing.md,
    ...
    headerTitle: { fontWeight: '800', color: COLORS.primaryDark, letterSpacing: -0.5, position: 'absolute', left: 0, right: 0, textAlign: 'center' },
